...
func main() {
	...
	*/
	router.HandleFunc("/tickets", apiServer.Tickets).Methods("GET")
	router.HandleFunc("/tickets/{id}", apiServer.Tickets).Methods("GET")
	router.HandleFunc("/tickets/{id}", apiServer.Tickets).Methods("DELETE")
	router.HandleFunc("/tickets/{id}", apiServer.Tickets).Methods("PUT")
	router.HandleFunc("/tickets", apiServer.Tickets).Methods("POST")
